...
class __TwigTemplate_f8599b642591ff459a8894a085046bad extends Template
{
    ...
    {
        return new Source("{# inline_template_start #}{% trans %}{{ date }} by {{ username }}{% endtrans %}{% if message %}<p class=\"revision-log\">{{ message }}</p>{% endif %}", "__string_template__fab93caf8d5e9ed2df000481dc171fc2", "");
    }
